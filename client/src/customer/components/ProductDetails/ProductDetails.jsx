...
<div className="flex flex-col items-center">
         ...
         {/* Product info */}
<div className="lg:col-sapn-1 max-w-2xl px-4 pb-16 sm:px-6 lg:mx-w-7xl lg:px-8 lg:pb-24">
          ...
          <div className="mt-4 lg:row-span-3 lg:mt-0">
            ...
            <p className='opacity-50 text-sm'>56744 Rating</p>
        ...
        <div className='border p-5'>
            <Grid container spacing={7}>
                <Grid item xs={7}>
                    ...
                    { [1,1,1,1,1,1].map((i)=>  <ProductReviewCard/>)}
                    </div>
                </Grid>
                <Grid item xs={5}>
<hl className="font-semibold  text-xl pb-2" >Product Ratings</hl>
<div className='flex items-center space-x-3'>
<Rating value={4.6} readOnly precision={.5}/>
<p className='opacity-60'>3455456 Ratings</p>
</div>
...
{feverMedicine.map((i)=><HomeSectionCard product={i}/>)}
</div>
      </section>
      </div>
    </div>
